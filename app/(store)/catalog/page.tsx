...
function CatalogContent() {
  ...
  const filterCategories = [
    ...
    { id: 'coins', name: 'Coins' },
    { id: 'cash', name: 'Cash' },
    { id: 'cues', name: 'Legendary Cue' },
    { id: 'pieces', name: 'Cue Pieces' },
    { id: 'events', name: 'Event Items' },
    { id: 'bundles', name: 'Special Bundles' }
  ];
      ...
      {filteredProducts.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filteredProducts.map((product, idx) => {
            ...
            // Cap staggered delay to prevent excessive wait for large lists
            const animationDelay = Math.min(idx * 0.05, 0.5); 
            
            return (
              <FadeIn key={product.id} delay={animationDelay} direction="up" fullWidth>
